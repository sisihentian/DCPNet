...
__all__ = ['SegmentationMetric_ISTD', 'SegmentationMetricTPFNFP_ISTD', 'ROCMetric_ISTD']
...
class SegmentationMetric_ISTD(object):
...
class SegmentationMetricTPFNFP_ISTD(object):
    """Computes pixAcc and mIoU metric scroes
    """
